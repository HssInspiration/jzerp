...
import co.dc.ccpt.modules.programmanage.mapper.CompanyMapper;
@Service
@Transactional
public class CompanyService extends CrudService<CompanyMapper, Company>{
	...
	public List<Company> listAllCompanyByNameExceptJz(String companyName){
		return companyMapper.listAllCompanyByNameExceptJz(companyName);
	} 
	...
	public List<Company> getCompListBySubIsBid(String subProId){
		return companyMapper.getCompListBySubIsBid(subProId);
	};
}
