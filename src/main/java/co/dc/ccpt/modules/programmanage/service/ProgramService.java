...
public class ProgramService extends CrudService<ProgramMapper, Program> {
	...
	public Page<Program> findPageForJyb(Page<Program> page, Program program) {
		dataRuleFilter(program);
		program.setPage(page);
		page.setList(programMapper.findListForJyb(program));
		return page;
	}
