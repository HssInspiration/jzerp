 ...
 */
package co.dc.ccpt.modules.act.utils;
...
import co.dc.ccpt.common.annotation.FieldName;
import co.dc.ccpt.common.config.Global;
import co.dc.ccpt.common.utils.Encodes;
import co.dc.ccpt.common.utils.ObjectUtils;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_SUB_ACT_CONTRACT = new String[]{"sub_contract", "oa_sub_contract"};//分包合同审批
