 ...
 */
package co.dc.ccpt.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new co.dc.ccpt.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new co.dc.ccpt.modules.sys.entity.User(null, userId)))){
