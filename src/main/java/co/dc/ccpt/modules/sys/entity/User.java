...
import co.dc.ccpt.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private String oldIdCardNum; // 身份证号码
	...
	public User(String id, String loginName, String idCardNum) {
		super(id);
	...
	public String getOldIdCardNum() {
		return oldIdCardNum;
	}

	public void setOldIdCardNum(String oldIdCardNum) {
		this.oldIdCardNum = oldIdCardNum;
	}
