...
<body>
	...
	<!-- 搜索 -->
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="bidtable" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="投标编号：">投标编号：</label>
				<form:input path="bidNum" htmlEscape="false" maxlength="64"  class=" form-control"/>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4">
