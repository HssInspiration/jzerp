...
<head>
	...
	<%@include file="contractPrintingList.js" %>	
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">总包合同用章管理列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="contractPrinting" class="form form-horizontal well clearfix">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<form:input path="proContract.user.name" htmlEscape="false" maxlength="64"  class=" form-control"/>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="contractprint:proprinting:print">
