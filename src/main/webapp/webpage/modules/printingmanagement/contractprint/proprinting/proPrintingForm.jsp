		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					...
					jp.post("${ctx}/contractprint/proprinting/updateStampStatus",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="contractPrinting" class="form-horizontal">
		<form:hidden path="id"/>
