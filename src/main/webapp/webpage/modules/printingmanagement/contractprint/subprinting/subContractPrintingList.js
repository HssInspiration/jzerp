...
$(document).ready(function() {
	$('#table').bootstrapTable({
		  //请求方法
               ...
               url: "${ctx}/contractprint/subprinting/data",
                   ...
                   if($el.data("item") == "edit"){
                   	edit(row.id);
                        ...
                        jp.confirm('确认要删除该记录吗？', function(){
                       	jp.loading();
                       	jp.get("${ctx}/contractprint/subprinting/delete?id="+row.id, function(data){
                   	  		if(data.success){
...
//		        sortable: true
  ...
  function print(id){//用印
	...
	jp.openDialog('用章', "${ctx}/contractprint/subprinting/printForm?id=" + id,'600px', '200px', $('#table'));
  }
