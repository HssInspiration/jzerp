...
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
<%-- 			<shiro:hasPermission name="deposit:deposit:add"> --%>
...
<%-- 			</shiro:hasPermission> --%>
<%-- 			<shiro:hasPermission name="deposit:deposit:del"> --%>
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
<%-- 			</shiro:hasPermission> --%>
<%-- 			<shiro:hasPermission name="deposit:deposit:import"> --%>
<!-- 				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button> -->
<!-- 				<div id="importBox" class="hide"> -->
<%-- 						<form id="importForm" action="${ctx}/deposit/import" method="post" enctype="multipart/form-data" --%>
