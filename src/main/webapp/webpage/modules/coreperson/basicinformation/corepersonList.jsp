			...
			<div class="accordion-group">
				<div id="collapseTwo" class="accordion-body collapse">
					<div class="accordion-inner">
						<form:form id="searchForm" modelAttribute="corePerson" class="form form-horizontal well clearfix">
<!-- 						<form id="searchForm"  class="form form-horizontal well clearfix" > -->
						    <div class="col-xs-12 col-sm-6 col-md-4">
						    	...
						    	<input id="type" name="user.name" class="form-control m-b"/>
						    </div>
						    <div class="col-xs-12 col-sm-6 col-md-4">
								<label class="label-item single-overflow pull-left" title="证书类型名称：">证书类型名称：</label>
								<form:select path="personCertificate.certificateName" class="form-control required">
...
<%-- 				</shiro:hasPermission> --%>
		    ...
		    <div  id="right" class="panel panel-default col-sm-6" style="display:none">
				<div class="panel-heading">
					<h3 class="panel-title"><label>证书列表,所属人员: </label><font id="corePersonLabel"></font><input type="hidden" id="corePersonId"/></h3>
				</div>
				<div class="panel-body">
				 <div id="personCertificateToolbar">
					<button id="personCertificateButton"  class="btn btn-outline btn-primary" title="添加证书"><i class="fa fa-plus-circle"></i> 添加证书</button>
				</div>
				 <!-- 表格 -->
			    <table id="personCertificateTable"
			           data-toolbar="#personCertificateToolbar"
			           data-id-field="id">
			    </table>
