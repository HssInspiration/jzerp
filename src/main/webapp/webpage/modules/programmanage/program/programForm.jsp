		   ...
		   <tbody>
		     <c:if test = "${isAdd}">
		       <tr>
		         ...
		         <td  class="width-35" >
		         	<form:input path="programName" placeholder="若为投标再指定,请输入投标时项目名" htmlEscape="false" maxlength="50" class="form-control required"/>
		         </td>
		       </tr>
		     </c:if>
		   	 <c:if test = "${edit}">
...
<%-- 					  </form:select> --%>
				  ...
				  <td class="width-35">
						<c:if test="${isAdd}">
							<form:select path="getMethod" class="form-control required" disabled="true">
