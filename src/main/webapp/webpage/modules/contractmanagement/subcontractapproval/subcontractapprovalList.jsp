...
<head>
	...
	<%@include file="subcontractapprovalList.js" %>	
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="subContractApproval" class="form form-horizontal well clearfix">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<form:input path="subProContract.subpackageProgram.subpackageProgramName" htmlEscape="false" maxlength="64"  class=" form-control"/>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="承包分公司：">承包方：</label>
					<form:input path="subProContract.subBidCompany.company.companyName" htmlEscape="false" maxlength="64"  class=" form-control"/>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<div class="col-xs-12">
						   <div class="col-xs-12 col-sm-5">
					        	  <div class='input-group date' id='beginContractDate' style="left: -10px;" >
					                   <input type='text'  name="subProContract.beginContractDate" id="beginDate" value="${subContractApproval.subProContract.beginContractDate}" class="form-control"  />
					        ...
					        <div class="col-xs-12 col-sm-5">
					          	<div class='input-group date' id='endContractDate' style="left: -10px;" >
					                   <input type='text'  name="subProContract.endContractDate" id="endDate" value="${subContractApproval.subProContract.subProContractDate}" class="form-control" />
					                   <span class="input-group-addon">
					                       <span class="glyphicon glyphicon-calendar"></span>
					                   </span>
					           	</div>	
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<form:select path="subContractStatus"  class="form-control m-b">
