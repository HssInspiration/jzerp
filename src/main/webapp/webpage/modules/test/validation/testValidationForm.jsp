...
<div class="row">
	...
	<div class="panel panel-primary">
					...
					<div class="col-sm-10">
						<p class="input-group">
							<div class='input-group form_datetime' id='newDate'>
			                    <input type='text'  name="newDate" class="form-control"  value="<fmt:formatDate value="${testValidation.newDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
		...
		<c:if test="${fns:hasPermission('test:validation:testValidation:edit') || isAdd}">
