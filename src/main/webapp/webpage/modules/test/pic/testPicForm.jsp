		...
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:hidden id="pic" path="pic" htmlEscape="false" maxlength="264" class="form-control"/>
						<sys:ckfinder input="pic" type="files" uploadPath="/test/pic/testPic" selectMultiple="true"/>
					</td>
				</tr>
				<tr>
