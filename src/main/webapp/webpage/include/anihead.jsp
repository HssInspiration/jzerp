...
<meta name="author" content="http://www.dingchang.co/"/>
...
<!-- 引入dckj ajax版本库文件，该文件压缩了jQuery，datatime等常用js文件以提高加载速度 -->
...
<!-- 引入layer插件,当做独立组件使用，不使用layui模块，layui 1.0目前还是beta版本不够强大，等2.0发布后我可以考虑推出一个完全用layui实现的dckj版本 -->
...
<script src="${ctxStatic}/common/js/ccpt.js"></script>